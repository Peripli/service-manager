...
func NewServiceOfferingController(repository storage.Repository, options *Options) *ServiceOfferingController {
	...
	return []web.Route{
		{
			Endpoint: web.Endpoint{
				...
				Path:   fmt.Sprintf("%s/{%s}", web.ServiceOfferingsURL, PathParamResourceID),
			},
