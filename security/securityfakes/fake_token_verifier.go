...
type FakeTokenVerifier struct {
	VerifyStub        func(ctx context.Context, token string) (sec.TokenData, error)
...
func (fake *FakeTokenVerifier) Verify(ctx context.Context, token string) (sec.TokenData, error) {
...
func (fake *FakeTokenVerifier) VerifyReturns(result1 sec.TokenData, result2 error) {
	fake.VerifyStub = nil
...
func (fake *FakeTokenVerifier) VerifyReturnsOnCall(i int, result1 sec.TokenData, result2 error) {
	fake.VerifyStub = nil
