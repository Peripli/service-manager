...
type FakeAuthenticator struct {
	AuthenticateStub        func(req *http.Request) (*sec.User, security.AuthenticationDecision, error)
...
func (fake *FakeAuthenticator) Authenticate(req *http.Request) (*sec.User, security.AuthenticationDecision, error) {
...
func (fake *FakeAuthenticator) AuthenticateReturns(result1 *sec.User, result2 security.AuthenticationDecision, result3 error) {
...
func (fake *FakeAuthenticator) AuthenticateReturnsOnCall(i int, result1 *sec.User, result2 security.AuthenticationDecision, result3 error) {
	fake.AuthenticateStub = nil
