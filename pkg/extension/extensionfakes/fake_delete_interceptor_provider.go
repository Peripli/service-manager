...
type FakeDeleteInterceptorProvider struct {
	...
	ProvideStub        func() extension.DeleteInterceptor
	provideMutex       sync.RWMutex
	provideArgsForCall []struct{}
	provideReturns     struct {
		result1 extension.DeleteInterceptor
	}
...
func (fake *FakeDeleteInterceptorProvider) Provide() extension.DeleteInterceptor {
...
func (fake *FakeDeleteInterceptorProvider) ProvideReturns(result1 extension.DeleteInterceptor) {
...
func (fake *FakeDeleteInterceptorProvider) ProvideReturnsOnCall(i int, result1 extension.DeleteInterceptor) {
	fake.ProvideStub = nil
...
var _ extension.DeleteInterceptorProvider = new(FakeDeleteInterceptorProvider)
