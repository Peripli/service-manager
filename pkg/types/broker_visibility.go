...
//go:generate smgen api BrokerVisibility
// BrokerVisibility broker struct
...
func (e *BrokerVisibility) SetCredentials(credentials *Credentials) {
	e.Credentials = credentials
}

func (e *BrokerVisibility) GetCredentials() *Credentials {
	return e.Credentials
}

// Validate implements InputValidator and verifies all mandatory fields are populated
func (e *BrokerVisibility) Validate() error {
	if e.Name == "" {
