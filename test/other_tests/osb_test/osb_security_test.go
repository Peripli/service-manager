...
var _ = Describe("OSB Security", func() {
	...
	BeforeEach(func() {
		plan := common2.GenerateFreeTestPlan()
		planID = gjson.Get(plan, "id").String()
		service := common2.GenerateTestServiceWithPlansWithID("1", plan)
		...
		platformForTenant := common2.RegisterPlatformInSM(common2.Object{
			"name": "test1",
			"type": "kubernetes",
	...
	Context("from other subaccount", func() {
		...
		BeforeEach(func() {
			...
			platformForOtherTenant := common2.RegisterPlatformInSM(common2.Object{
				"name": "test2",
				"type": "kubernetes",
