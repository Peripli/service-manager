...
type notificationTypeEntry struct {
	...
	ResourceCreateFunc func() common2.Object
	// ResourceUpdateFunc is blueprint for resource update
	ResourceUpdateFunc func(obj common2.Object, update common2.Object) common2.Object
	// ResourceUpdates are the test updates to be performed (returns the update body json)
	ResourceUpdates []func() common2.Object
	// ResourceDeleteFunc is blueprint for resource deletion
	ResourceDeleteFunc func(obj common2.Object)
	// ExpectedPlatformIDsFunc calculates the expected platform IDs for the given object
	ExpectedPlatformIDsFunc func(obj common2.Object) []string
	// ExpectedAdditionalPayloadFunc calculates the expected additional payload for the given object
	ExpectedAdditionalPayloadFunc func(expected common2.Object, repository storage.Repository) string
	// Verify additional stuff such as creation of notifications for dependant entities
	AdditionalVerificationNotificationsFunc func(expected common2.Object, repository storage.Repository, notificationsAfterOp *types.Notifications)
...
var _ = Describe("Notifications Suite", func() {
	...
	entries := []notificationTypeEntry{
		{
			...
			ResourceUpdates: []func() common2.Object{
				...
				func() common2.Object {
					anotherPlatformID := ctx.SMWithOAuth.POST(web.PlatformsURL).WithJSON(common2.Object{
						"id":          "cluster1",
						"name":        "k8s1",
						"type":        "kubernetes",
			...
			ResourceDeleteFunc: func(object common2.Object) {
				ctx.CleanupBroker(object["id"].(string))
			},
			ExpectedPlatformIDsFunc: func(object common2.Object) []string {
		...
		},
		{
			...
			ResourceCreateFunc: func() common2.Object {
				visReqBody := make(common2.Object)
				...
				platformID := ctx.SMWithOAuth.POST(web.PlatformsURL).WithJSON(common2.GenerateRandomPlatform()).
					Expect().
	...
	BeforeSuite(func() {
		...
		ctx = common2.NewTestContextBuilderWithSecurity().WithSMExtensions(func(ctx context.Context, smb *sm.ServiceManagerBuilder, e env.Environment) error {
	...
	for _, entry := range entries {
		...
		verifyCreationNotificationCreated := func(objAfterOp common2.Object, notificationsAfterOp *types.Notifications) {
			found := false
			for _, notification := range notificationsAfterOp.Notifications {
				...
				resource := gjson.GetBytes(notification.Payload, "new.resource").Value().(common2.Object)
		...
		verifyDeletionNotificationCreated := func(objAfterOp common2.Object, notificationsAfterOp *types.Notifications, expectedOldPayload string) {
			found := false
			for _, notification := range notificationsAfterOp.Notifications {
				...
				resource := gjson.GetBytes(notification.Payload, "old.resource").Value().(common2.Object)
				delete(resource, "updated_at")
				delete(objAfterOp, "updated_at")
				Expect(resource).To(Equal(objAfterOp))
		...
		verifyModificationNotificationsCreated := func(objBeforeOp, objAfterOp, update common2.Object, notificationsAfterOp *types.Notifications) {
			found := false
			...
			for _, notification := range notificationsAfterOp.Notifications {
				...
				oldResource := gjson.GetBytes(notification.Payload, "old.resource").Value().(common2.Object)
				...
				newResource := gjson.GetBytes(notification.Payload, "new.resource").Value().(common2.Object)
		...
		Context(fmt.Sprintf("ON %s resource UPDATE", entry.ResourceType), func() {
			...
			updateOpEntries := func(updates []func() common2.Object) []TableEntry {
			...
			DescribeTable("also creates one or more notifications", func(update func() common2.Object) {
				_, ids := getNotifications()
				updateBody := update()
	...
	Context("When resource creation fails after the transaction is commited", func() {
		var customCtx *common2.TestContext
		BeforeEach(func() {
			customCtx = common2.NewTestContextBuilderWithSecurity().WithSMExtensions(func(ctx context.Context, smb *sm.ServiceManagerBuilder, e env.Environment) error {
...
func regBroker(ctx *common2.TestContext) {
	brokerServer := common2.NewBrokerServerWithCatalog(common2.NewRandomSBCatalog())
	...
	brokerJSON := common2.Object{
		"name":        UUID.String(),
		"broker_url":  brokerServer.URL(),
		"description": UUID2.String(),
		"credentials": common2.Object{
			"basic": common2.Object{
