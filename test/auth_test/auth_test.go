...
var _ = Describe("Service Manager Authentication", func() {
	...
	Context("Failing security scenarios", func() {
		...
		authRequests := []struct {
			...
			// OPERATIONS
			{"Missing authorization header", "GET", web.OperationsURL + "/999", emptyAuthHeader},
			{"Invalid authorization schema", "GET", web.OperationsURL + "/999", invalidBasicAuthHeader},
			{"Missing token in authorization header", "GET", web.OperationsURL + "/999", emptyBearerAuthHeader},
			{"Invalid token in authorization header", "GET", web.OperationsURL + "/999", invalidBearerAuthHeader},
			...
			{"valid basic in authorization header", "GET", web.OperationsURL, validBasicAuthHeader},
