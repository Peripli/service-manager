...
type FakeServiceOffering struct {
	CreateStub        func(ctx context.Context, serviceOffering *types.ServiceOffering) error
...
func (fake *FakeServiceOffering) Create(ctx context.Context, serviceOffering *types.ServiceOffering) error {
