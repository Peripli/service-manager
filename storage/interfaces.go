...
type Repository interface {
	...
	QueryForList(ctx context.Context, objectType types.ObjectType, queryName NamedQuery, queryParams map[string]interface{},elements...string) (types.ObjectList, error)
