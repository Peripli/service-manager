...
type Repository interface {
	...
	// List retrieves all objects of particular type from SM DB
	...
	ListWithPaging(ctx context.Context, objectType types.ObjectType, maxItems string, token string, criteria ...query.Criterion) (*types.ObjectPage, error)
