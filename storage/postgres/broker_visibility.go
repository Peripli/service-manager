...
func (*BrokerVisibility) FromObject(object types.Object) (storage.Entity, bool) {
	broker, ok := object.(*types.BrokerVisibility)
	if !ok {
		return nil, false
	}
